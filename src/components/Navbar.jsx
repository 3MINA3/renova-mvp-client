  ...
  return (
    <nav className="bg-white/90 dark:bg-slate-950/90 backdrop-blur-xl sticky top-0 z-50 border-b border-gray-100 dark:border-slate-800/80 shadow-sm transition-colors duration-300">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        {/* Logo */}
        <Link to="/" className="relative flex items-center justify-center p-0.5 rounded-2xl group transition-all duration-500 hover:shadow-[0_0_20px_rgba(16,185,129,0.3)]">
          ...
          <div className="relative bg-white dark:bg-slate-900 rounded-xl overflow-hidden p-1 z-10">
            <img 
              src="/logo.png" 
              alt="Renova Logo" 
              className="h-10 md:h-14 w-auto object-contain transition-transform duration-700 group-hover:scale-105 rounded-xl" 
            />
          </div>
        </Link>
        ...
        <div className="flex items-center gap-3 sm:gap-5 md:gap-8">
          ...
          <Link
            to="/favorites"
            className={`relative flex items-center justify-center w-10 h-10 rounded-full transition-all duration-300 ${isActive('/favorites') ? 'text-red-500 bg-red-50 hover:bg-red-100 dark:bg-red-900/20 dark:hover:bg-red-900/40 dark:text-red-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800'}`}
            title="المفضلة"
            aria-label="المفضلة"
          >
          ...
          <Link
            to="/cart"
            className={`relative flex items-center justify-center w-10 h-10 rounded-full transition-all duration-300 ${isActive('/cart') ? 'text-teal-600 bg-teal-50 hover:bg-teal-100 dark:bg-teal-900/20 dark:hover:bg-teal-900/40 dark:text-teal-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800'}`}
            title="السلة"
            aria-label="السلة"
          >
          ...
          {isAuthenticated ? (
            <div className="flex items-center gap-2 sm:gap-4">
              <Link
                to="/my-orders"
                className={`flex items-center gap-2 text-sm font-bold px-3 py-2 rounded-xl transition-all ${isActive('/my-orders') ? 'text-teal-600 bg-teal-50 hover:bg-teal-100 dark:bg-teal-900/20 dark:hover:bg-teal-900/40 dark:text-teal-400' : 'text-gray-600 dark:text-gray-300 hover:text-teal-600 dark:hover:text-teal-400 hover:bg-gray-50 dark:hover:bg-slate-800'}`}
                title="طلباتي"
                aria-label="طلباتي"
              >
